...
function checkResponse(){
       let user = document.getElementById("response").value;
       ...
       if (user == correct){
              ...
              msg = `The Answer is Correct <br> <img src= "${filename}">`;

       }else{
              filename = "incorrect.avif";
              msg = `The Answer is Incorrect, The correct answer is ${correct} <br> <img src= "${filename}">`;
       }
